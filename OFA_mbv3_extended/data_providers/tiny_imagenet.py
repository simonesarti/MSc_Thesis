...
from OFA_mbv3_extended.utils.common_tools import rename_subfolders

__all__ = ["TinyImagenetDataProvider"]
...
class TinyImagenetDataProvider(DataProvider):
    ...
    def __init__(
        ...
        if not isinstance(self.image_size, int):
            ...
            self.image_size.sort()  # e.g., 48 -> 64
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = "running_experiment/datasets/private/tiny-imagenet/tiny-imagenet-200"
    ...
    # test set not labelled, therefore use validation set as test set, and partition train set to obtain
    ...
    def build_train_transform(self, image_size=None, print_log=True):
        ...
        if isinstance(image_size, list):
            ...
            print(
                "Use MyModRandomResizedCrop: %s, \t %s"
    ...
    '''
    This method is responsible for separating validation images into separate sub folders, modified from
    https://github.com/DennisHanyuanXu/Tiny-ImageNet/blob/f08f6e69375a8142ecdff76afd9457620f399f48/src/data_prep.py
    '''
    ...
    '''
    This method is responsible for converting the class identifier to the class name, modified from
    https://github.com/DennisHanyuanXu/Tiny-ImageNet/blob/f08f6e69375a8142ecdff76afd9457620f399f48/src/data_prep.py
    '''
