...
if __name__ == "__main__":
    ...
    with open("running_experiment/pred_samples.json", "w") as f:
                ...
                for n_tr_samples in n_train_samples:
                    for i in range(1, n_iter + 1):
                        ...
                        if feature_encoding == "one-hot" and (surrogate == "rbf" or surrogate == "rbfs"):
                            ...
                            with open("running_experiment/pred_comparisons.txt", "a") as f:
    ...
    with open("running_experiment/pred_results.json", "w") as f:
        json.dump(results, f)
