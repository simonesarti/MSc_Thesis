...
def train(epochs, net, data_provider, criterion, optimizer, scheduler, log_file, save_path, patience, step):
    ...
    for epoch in range(1, epochs + 1):
        ...
        train_loss, (train_top1, train_top5) = train_one_epoch(epoch, net, data_provider.train, criterion, optimizer, scheduler)
        valid_provider = data_provider.valid if data_provider.valid is not None else data_provider.test
        valid_loss, (valid_top1, valid_top5) = validate_se(net, valid_provider, criterion, epoch-1)
...
def train_one_epoch(epoch, net, train_loader, criterion, optimizer, scheduler):
...
if __name__ == "__main__":
    ...
    for step in [1, 2]:
        ...
        # test
        test_loss, (test_top1, test_top5) = validate_se(subnet, data_provider.test, criterion)
