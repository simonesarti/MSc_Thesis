...
class AdditioanlCIFAR10(data.Dataset):
    ...
    def __init__(self, root, transform=None, target_transform=None):
        ...
        self.test_data = np.load(os.path.join(self.additional_data_root, self.new_test_data))
        self.test_labels = np.load(os.path.join(self.additional_data_root, self.new_test_labels)).tolist()
