...
class Food101DataProvider(DataProvider):
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = 'running_experiment/datasets/private/food-101'
    ...
    def train_dataset(self, _transforms):
        ...
        dataset = torchvision.datasets.Food101(root=self.train_path, split="train", download=True, transform=_transforms)
        return dataset
    ...
    def test_dataset(self, _transforms):
        ...
        dataset = torchvision.datasets.Food101(root=self.test_path, split="test", download=True, transform=_transforms)
        return dataset
