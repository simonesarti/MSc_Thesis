...
class CIFAR10DataProvider(DataProvider):
    ...
    def __init__(
        ...
        if valid_size is not None:
            ...
            # in case no valid size is provided, we use new cifar10 test
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = 'running_experiment/datasets/private/cifar10'
    ...
    def build_valid_transform(self, image_size=None):
        ...
        return transforms.Compose([
            transforms.Resize(image_size, InterpolationMode.BICUBIC),
            transforms.ToTensor(),
            self.normalize,
        ])
...
class CIFAR100DataProvider(DataProvider):
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = 'running_experiment/datasets/private/cifar100'
...
class CINIC10DataProvider(DataProvider):
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = 'running_experiment/datasets/private/CINIC10'
    ...
    def test_dataset(self, _transforms):
        dataset = torchvision.datasets.ImageFolder(self.test_path, transform=_transforms)
        return dataset
